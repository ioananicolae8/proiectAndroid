...
public class Pacient_LogInActivity extends AppCompatActivity implements View.OnClickListener, IAuthentication {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_log_in_pacient);
    ...
    protected void onResume() {
        super.onResume();
        ConnectionHelper.hasConnection(Pacient_LogInActivity.this);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.goToRegistrationTextView:
                Intent register = new Intent(Pacient_LogInActivity.this, Pacient_RegisterActivity.class);
                startActivity(register);
                break;

            case R.id.forgotPasswordTextView:
                Intent forgotPassword = new Intent(Pacient_LogInActivity.this, ForgotPasswordActivity.class);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            TipUtilizatorLogatHelper.seteazaTipUtilizatorLogat(Pacient_LogInActivity.this, ETipUtilizator.PACIENT);
//                            ToastHelper.showToastWithImage(Pacient_LogInActivity.this, "Bun venit!", R.drawable.icon_success);
                            Intent intent = new Intent(Pacient_LogInActivity.this, Pacient_MenuActivity.class);
                            startActivity(intent);
                        } else {
                            viewPassword.getText().clear();
                            resetAnimation();
//                            ToastHelper.showToastWithImage(Pacient_LogInActivity.this, getString(R.string.login_access_denied), R.drawable.icon_access_denied);
                        }
                    }
                });
    }
